...
void loadDialogBackground(int dialog_num)
{
	switch(dialog_num)
	{
	case 0 : PA_LoadBackground(0, 1, &bg_edit_dialog); break;	// ADD
	case 1 : PA_LoadBackground(0, 1, &bg_dialog);break;			// DELETE
	case 2 : PA_LoadBackground(0, 1, &bg_edit_dialog); break;	// MOVE
	case 3 : PA_LoadBackground(0, 1, &bg_dialog); break;		// ALERT
	}
}
