...
extern volatile unsigned portLONG ulCriticalNesting;					\
	...
	asm volatile ("SUB		LR, LR, #0x4\n\t");							\
	asm volatile ("STMDB SP!, {R0} \n\t");								\
	asm volatile ("MOV  R0, #0x4000001 \n\t");							\
	asm volatile ("STR  r0, [r0, #0x207] \n\t");						\
...
extern volatile unsigned portLONG ulCriticalNesting;					\
	...
	__asm__ __volatile__ ("STMDB	R0!, {LR}\n\t");					\
	__asm__ __volatile__ ("MOV	LR, R0\n\t");							\
	__asm__ __volatile__ ("LDMIA	SP!, {R0}\n\t");					\
	__asm__ __volatile__ ("STMDB	LR,{R0-LR}^\n\t");					\
	__asm__ __volatile__ ("NOP\n\t");									\
	__asm__ __volatile__ ("SUB	LR, LR, #60\n\t");						\
	__asm__ __volatile__ ("MRS	R0, SPSR\n\t");							\
	__asm__ __volatile__ ("STMDB	LR!, {R0}\n\t");					\
	__asm__ __volatile__ ("LDR	R0, =ulCriticalNesting\n\t");			\
	__asm__ __volatile__ ("LDR	R0, [R0]\n\t");							\
	__asm__ __volatile__ ("STMDB	LR!, {R0}\n\t");					\
	__asm__ __volatile__ ("LDR	R0, =pxCurrentTCB\n\t");				\
	__asm__ __volatile__ ("LDR	R0, [R0]\n\t");							\
	__asm__ __volatile__ ("STR	LR, [R0]\n\t");							\
	( void ) ulCriticalNesting;											\
	( void ) pxCurrentTCB;												\
}
...
#if 0
	#define portYIELD()					__asm__ __volatile__ ( "SWI 0" )
#endif
	#define portYIELD()					__asm__ __volatile__ ("swi #0x06 \n\t" : : : "r0")
