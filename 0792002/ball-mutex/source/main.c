...
static portTASK_FUNCTION(Ball_Task, pvParameters)
{
	...
	while(1) {
		if (NDS_SWITCH() & KEY_R) {
			if ((x == 4 && y == 3))
				xSemaphoreTake(xSemaphore1, (portTickType)1000);
			else if ((x == 4 && y == 6))
				xSemaphoreTake(xSemaphore2, (portTickType)1000);
			else if ((x == 4 && y == 9))
				xSemaphoreTake(xSemaphore3, (portTickType)1000);
			else if ((x == 8 && y == 3))
				xSemaphoreTake(xSemaphore4, (portTickType)1000);
			else if ((x == 8 && y == 6))
				xSemaphoreTake(xSemaphore5, (portTickType)1000);
			else if ((x == 8 && y == 9))
				xSemaphoreTake(xSemaphore6, (portTickType)1000);
			else if ((x == 12 && y == 3))
				xSemaphoreTake(xSemaphore7, (portTickType)1000);
			else if ((x == 12 && y == 6))
				xSemaphoreTake(xSemaphore8, (portTickType)1000);
			else if ((x == 12 && y == 9))
				xSemaphoreTake(xSemaphore9, (portTickType)1000);
		}
