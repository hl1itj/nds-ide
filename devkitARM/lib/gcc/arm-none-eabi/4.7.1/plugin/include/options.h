...
enum opt_code
{
  ...
  OPT_mapcs = 985,                           /* -mapcs */
  OPT_mapcs_float = 986,                     /* -mapcs-float */
  OPT_mapcs_frame = 987,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 988,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 989,               /* -mapcs-stack-check */
  OPT_march_ = 990,                          /* -march= */
  OPT_marm = 991,                            /* -marm */
  OPT_mbig_endian = 992,                     /* -mbig-endian */
  ...
  OPT_mfpu_ = 1005,                          /* -mfpu= */
  /* OPT_mhard_float = 1006, */              /* -mhard-float */
  OPT_mlittle_endian = 1007,                 /* -mlittle-endian */
  OPT_mlong_calls = 1008,                    /* -mlong-calls */
  OPT_mpic_register_ = 1009,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1010,            /* -mpoke-function-name */
  OPT_msched_prolog = 1011,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1012,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1013, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1014,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1015,                         /* -mthumb */
  OPT_mthumb_interwork = 1016,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1017,                  /* -mtls-dialect= */
  OPT_mtp_ = 1018,                           /* -mtp= */
  OPT_mtpcs_frame = 1019,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1020,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1021,                         /* -mtune= */
  OPT_munaligned_access = 1022,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1023,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1024,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1025,              /* -mword-relocations */
  OPT_mwords_little_endian = 1026,           /* -mwords-little-endian */
  OPT_n = 1027,                              /* -n */
  OPT_no_canonical_prefixes = 1028,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1029,              /* -no-integrated-cpp */
  OPT_nocpp = 1030,                          /* -nocpp */
  OPT_nodefaultlibs = 1031,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1032,                   /* -nostartfiles */
  OPT_nostdinc = 1033,                       /* -nostdinc */
  OPT_nostdinc__ = 1034,                     /* -nostdinc++ */
  OPT_nostdlib = 1035,                       /* -nostdlib */
  OPT_o = 1036,                              /* -o */
  OPT_p = 1037,                              /* -p */
  OPT_pass_exit_codes = 1038,                /* -pass-exit-codes */
  OPT_pedantic = 1039,                       /* -pedantic */
  OPT_pedantic_errors = 1040,                /* -pedantic-errors */
  OPT_pg = 1041,                             /* -pg */
  OPT_pie = 1042,                            /* -pie */
  OPT_pipe = 1043,                           /* -pipe */
  ...
  OPT_print_objc_runtime_info = 1049,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1050,               /* -print-prog-name= */
  OPT_print_search_dirs = 1051,              /* -print-search-dirs */
  OPT_print_sysroot = 1052,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1053,   /* -print-sysroot-headers-suffix */
  ...
  OPT_std_c__11 = 1073,                      /* -std=c++11 */
  OPT_std_c__98 = 1074,                      /* -std=c++98 */
  OPT_std_c11 = 1075,                        /* -std=c11 */
  ...
  OPT_std_f2008ts = 1083,                    /* -std=f2008ts */
  OPT_std_f95 = 1084,                        /* -std=f95 */
  OPT_std_gnu = 1085,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1086, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1087, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1088,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1089,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1090,                      /* -std=gnu11 */
  ...
  /* OPT_std_iso9899_2011 = 1100, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1101,                     /* -std=legacy */
  OPT_symbolic = 1102,                       /* -symbolic */
  OPT_t = 1103,                              /* -t */
  OPT_time = 1104,                           /* -time */
  OPT_time_ = 1105,                          /* -time= */
  OPT_traditional = 1106,                    /* -traditional */
  OPT_traditional_cpp = 1107,                /* -traditional-cpp */
  OPT_trigraphs = 1108,                      /* -trigraphs */
  OPT_u = 1109,                              /* -u */
  OPT_undef = 1110,                          /* -undef */
  OPT_v = 1111,                              /* -v */
  OPT_version = 1112,                        /* -version */
  OPT_w = 1113,                              /* -w */
  OPT_wrapper = 1114,                        /* -wrapper */
  OPT_x = 1115,                              /* -x */
  OPT_z = 1116,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
